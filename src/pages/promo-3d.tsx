...
const pageMetadata = {
    uk: {
        title: 'Дизайн проект квартири в 3D',
        description: "Виконаємо 3D дизайн проект інтер'єру квартири",
    },
    ru: {
        title: 'Дизайн проект квартиры в 3D',
        description: 'Выполним 3D дизайн проект интерьера  квартиры',
    },
    en: {
        title: 'Apartment design in 3D',
        description:
            'We will design the interior project of the entire apartment ',
    },
}
...
const Posadka3d = ({ data }: { data: imagesDataProp }) => {
    ...
    const onScroll = () => {
        const block = document.getElementById('block3d')
    ...
    return (
        <div>
            ...
            <Desktop id="block3d" onScroll={onScroll}>
                <Header />
                <WrapDesktop>
